        ...
        (defun motion-selection ()
            (cond
             ...
             ((and prometheus--last-point-position
                   ...
                   (not (memq this-command '(forward-char backward-char self-insert-command eat-self-input next-line previous-line pixel-scroll-precision pop-global-mark expreg-expand expreg-contract)))
            ...
            (setq-local prometheus--last-point-position (point)))
        (add-hook 'post-command-hook 'motion-selection)
